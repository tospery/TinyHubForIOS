...
class RepoBasicCell: BaseCollectionCell, ReactorKit.View {
    ...
    lazy var avatarImageView: UIImageView = {
        ...
        imageView.size = TinyHub.Metric.BasicCell.avatarSize
        return imageView
    }()
    ...
    override func layoutSubviews() {
        ...
        self.avatarImageView.left = TinyHub.Metric.BasicCell.margin.left
        self.avatarImageView.top = TinyHub.Metric.BasicCell.margin.top
        self.langLabel.sizeToFit()
        self.langLabel.left = self.avatarImageView.right + TinyHub.Metric.BasicCell.padding.horizontal
        self.langLabel.bottom = self.avatarImageView.bottom - 2
        self.forksLabel.sizeToFit()
        self.forksLabel.width = TinyHub.Metric.BasicCell.forksWidth
        ...
        self.nameLabel.extendToRight = self.contentView.width - TinyHub.Metric.BasicCell.margin.right
        ...
        self.descLabel.extendToRight = self.contentView.width - TinyHub.Metric.BasicCell.margin.right
    ...
    override class func size(width: CGFloat, item: BaseCollectionItem) -> CGSize {
        .init(width: width, height: TinyHub.Metric.BasicCell.height)
    }
