...
class UserBasicCell: BaseCollectionCell, ReactorKit.View {
    ...
    override func layoutSubviews() {
        ...
        self.userLabel.left = self.avatarImageView.right + TinyHub.Metric.BasicCell.padding.horizontal
        self.userLabel.top = self.avatarImageView.top
        self.userLabel.extendToRight = self.contentView.width - TinyHub.Metric.BasicCell.margin.right
        ...
        self.descLabel.width = self.contentView.width - TinyHub.Metric.BasicCell.margin.horizontal
...
extension Reactive where Base: UserBasicCell {
